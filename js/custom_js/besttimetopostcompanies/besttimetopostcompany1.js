function populateBestTimeToPost1(data) {
    var heatmap1options = {
        chart: {
    ...
    var heatmap1chart = new ApexCharts(document.querySelector("#besttimetopostcompany1"), heatmap1options);
