function populateEmotionChartAnalysis1(data) {
    var emotionanalysiscompany1options = {
        series: [{
            name: 'Emotions',
            data: data.series[0].data  // Data for all emotions in one array
        }],
        chart: {
            type: 'radar',
            height: 350,
    ...
    var emotionanalysiscompany1chart = new ApexCharts(document.querySelector("#emotionanalysiscompany1"), emotionanalysiscompany1options);
    emotionanalysiscompany1chart.render();
}
